...
import 'package:soriana_tracker/ui/widgets/components/intl_phone_field-master/lib/countries.dart';
import 'package:soriana_tracker/ui/widgets/components/intl_phone_field-master/lib/helpers.dart';
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, index) => Column(
                  children: <Widget>[
                    ListTile(
                      leading: Image.asset(
                        'flags/${_filteredCountries[index].code.toLowerCase()}.png',
                        width: 32,
                      ),
