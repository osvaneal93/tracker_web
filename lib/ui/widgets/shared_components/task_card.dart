...
import 'package:soriana_tracker/ui/widgets/shared_components/list_profil_image.dart';
                ...
                children: [
                  ElevatedButton(
                    ...
                    child: Text(
                      ...
                      style:
                          styles.smallStyle(context, color: colors.whiteColor),
                    ),
                  ),
                  ListProfilImage(
...
class _Tile extends StatelessWidget {
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(child: _title(title, context)),
  ...
  Widget _title(String data, BuildContext context) {
    return Text(
      data,
